...
/***/ function(module, exports, __webpack_require__) {
	...
	var onLogOut = function onLogOut(event) {
	  event.preventDefault();
	  api.logOut().done(ui.logOut).fail(ui.logOutFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logIn = function logIn(data, textStatus, jqXHR, signUpData) {
	  var request = $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var home = __webpack_require__(8);
	var logInForm = __webpack_require__(28);
	var signUpForm = __webpack_require__(29);
	...
	var renderSuccess = function renderSuccess(message) {
	  var success = __webpack_require__(31);
	...
	var renderProfile = function renderProfile(data) {
	  ...
	  var userProfile = __webpack_require__(32);
	...
	var showAuth = function showAuth(authForm) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"user-profile\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"nav","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n  <div class=\"greeting\">\n    <div class=\"overlay\">\n      "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.greeting : depth0), depth0))
	    + "\n    </div>\n  </div>\n\n  <div class=\"message\">\n  </div>\n\n  <div class=\"profile-contents\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"allLists","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  </div>\n\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "    <div class=\"user-nav\">\n      <a class=\"log-out\" title=\"Log out\" href=\"\">\n        <i class=\"fa fa-power-off\" aria-hidden=\"true\"></i>\n      </a>\n      <a class=\"change-password-link\" title=\"Change password\" href=\"\">\n        <i class=\"fa fa-gear aria-hidden=\"true\"></i>\n      </a>\n    </div>\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"passwordForm","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	  ...
	  return "<nav>\n"
	    ...
	    + "  <span class=\"logo\">\n    <a href=\"\" class=\"home-link\">\n      <i class=\"fa fa-suitcase\" aria-hidden=\"true\"></i><span class=\"app-name\"> go bag</span>\n    </a>\n  </span>\n  \n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetAllLists = function onGetAllLists() {
	  // if ($(event.target).is('a'))  {
	  event.preventDefault();
	  // 
	  api.getAllLists().done(ui.renderAllLists).fail(ui.getFailure);
	};

	var onNewList = function onNewList(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.newList(data).done(onGetAllLists).fail(ui.createListFailure);
	};

	var onGetList = function onGetList(data) {
	  ...
	  api.getList(list_id).done(function (data) {
	    ui.renderList(data);
	    $('.item-search').autocomplete(api.autocompleteOptions);
	  }).fail(ui.getFailure);
	};

	var onCloneList = function onCloneList() {
	  event.preventDefault();
	  var list_id = $(event.target).parents('li').attr('data-id');
	  console.log(list_id);
	  api.cloneList(list_id).done(onGetAllLists).fail(ui.createListFailure);
	};

	var onAddItemToList = function onAddItemToList(event) {
	  event.preventDefault();
	  var contentData = getFormFields(event.target);
	  contentData.content.item_id = $(event.target).find('.item-search').attr('data-id');
	  if (contentData.content.item_id) {
	    api.addItemToList(contentData).done(onGetList).fail(ui.addItemFailure);
	  } else {
	    api.addNewItem(contentData).done(function (data) {
	      var newContentData = {
	        content: {
	      ...
	      api.addItemToList(newContentData).done(onGetList).fail(ui.addItemFailure);
	...
	var onDeleteList = function onDeleteList(event) {
	  ...
	  console.log(list_id);
	  api.deleteList(list_id).done(onGetAllLists).fail(ui.deleteListFailure);
	};
	...
	var onDeleteContent = function onDeleteContent(event) {
	  ...
	  api.deleteContent(content_id).done(function () {
	    console.log('successfully deleted content');
	    onGetList(list_id);
	  }).fail(ui.deleteItemFailure);
	};

	var onTogglePackedContent = function onTogglePackedContent(event) {
	  var content_id = $(event.target).parent().attr('data-id');
	  console.log('content id', content_id);
	  var packed = $(event.target).prop('checked');
	  ...
	  console.log(data);
	  api.updateContent(data).done(function () {
	    onGetList(list_id);
	  }).fail(ui.updateItemFailure);
	};

	var onEditList = function onEditList(event) {
	  event.preventDefault();
	  var title = $(event.target).parents('form').find('.list-title').html();
	  console.log(title);
	  ui.editListTitle(title);
	};

	var onCancelEditList = function onCancelEditList(event) {
	  event.preventDefault();
	  var list_id = $(event.target).parents('form.add-item').attr('data-id');
	  console.log(list_id);
	  onGetList(list_id);
	};
	...
	var onUpdateList = function onUpdateList(event) {
	  ...
	  var list_id = $(event.target).parents('form.add-item').attr('data-id');
	  console.log(list_id);
	  var formData = getFormFields(document.getElementsByClassName('add-item')[0]);
	  ...
	  api.updateList(data).done(function () {
	    api.getList(list_id).done(function (data) {
	      ui.renderList(data);
	      $('.item-search').autocomplete(api.autocompleteOptions);
	    }).fail(ui.getFailure);
	...
	var onToggleNewListForm = function onToggleNewListForm() {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newList = function newList(data) {
	  console.log('in api');
	  var request = $.ajax({
	    url: app.host + '/lists',
	    method: 'POST',
	...
	var getList = function getList(data) {
	  ...
	  var list_id = Number.isInteger(Number.parseInt(data, 10)) ? data : data.content.list.id;
	  var request = $.ajax({
	...
	var addItemToList = function addItemToList(data, textStatus, jqXHR, contentData) {
	...
	var deleteContent = function deleteContent(content_id) {
	  return $.ajax({
	...
	var cloneList = function cloneList(list_id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchForItems = function searchForItems(items) {
	  console.log(items);
	};

	var renderList = function renderList(data) {
	  var list = data.list;
	  var singleList = __webpack_require__(40);
	  $('.profile-contents').html(singleList(list));
	};

	var renderAllLists = function renderAllLists(lists) {
	  console.log(lists);
	  var allLists = __webpack_require__(35);
	  $('.profile-contents').html(allLists(lists));
	};

	var editListTitle = function editListTitle(title) {
	  var listHeaderEdit = __webpack_require__(42);
	  $('.list-header').html(listHeaderEdit({ title: title }));
	};

	var toggleNewListForm = function toggleNewListForm() {
	  var newListForm = __webpack_require__(43);
	...
	module.exports = {
	  ...
	  toggleNewListForm: toggleNewListForm
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form class=\"add-item\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">\n  <div class=\"list-header\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(41),depth0,{"name":"listHeader","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  </div>\n  <input type=\"hidden\" name=\"content[list_id]\" value=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1>\n  <span class=\"list-title list-title-edit\">"
	    + container.escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"title","hash":{},"data":data}) : helper)))
	    + "</span>\n  <small>\n    <a href=\"\" class=\"edit-list\" title=\"Edit title\">\n      <i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>\n    </a>\n    <a href=\"\" class=\"delete-list\" title=\"Delete list\">\n      <i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i>\n    </a>\n    <a href=\"\" class=\"close-list\">\n      <i class=\"fa fa-times-circle-o\" aria-hidden=\"true\"></i>\n    </a>\n  </small>\n</h1>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1>\n  <span class=\"list-title\">\n    <input type=\"text\" name=\"list[title]\" value=\""
	    + container.escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"title","hash":{},"data":data}) : helper)))
	    + "\" class=\"title-field\">\n  </span>\n  <a href=\"\" class=\"update-list\"><i class=\"fa fa-check-circle-o\" aria-hidden=\"true\"></i></a>\n  <a href=\"\" class=\"cancel-edit-list\">\n    <i class=\"fa fa-times-circle-o\" aria-hidden=\"true\"></i>\n  </a>\n</h1>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form class=\"new-list-form\">\n  <label for=\"list[title]\">Title</label>\n  <input name=\"list[title]\" id=\"list[title]\" type=\"text\" placeholder=\"Where are you going?\" required>\n  <button type=\"submit\"><i class=\"fa fa-check-circle-o\" aria-hidden=\"true\"></i></button>\n  <a class=\"cancel-new-list\" href=\"\"><i class=\"fa fa-times-circle-o\" aria-hidden=\"true\"></i></a>\n</form>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "135149ed847d34cca0b6496908246bb9.jpg";

/***/ },
/* 53 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f5fab6d3e507f083c9971295680478ec.jpg";

/***/ },
/* 54 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "ca1a890517a8cb42fd10cfa6456913b7.jpg";

/***/ },
/* 55 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "2d4669e691b8f18e36bc3a7fbc8cd637.jpg";
	...
	*/
	!function (a) {
	  ...
	  function b(c, d) {
	    ...
	    if (!b) return a.value;var d = "(" + c.escapeRegExChars(b) + ")";return a.value.replace(new RegExp(d, "gi"), "<strong>$1</strong>").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/&lt;(\/?strong)&gt;/g, "<$1>");
	      ...
	      var c = this,
	          d = c.options;a.extend(d, b), c.isLocal = a.isArray(d.lookup), c.isLocal && (d.lookup = c.verifySuggestionsFormat(d.lookup)), d.orientation = c.validateOrientation(d.orientation, "bottom"), a(c.suggestionsContainer).css({ "max-height": d.maxHeight + "px", width: d.width + "px", "z-index": d.zIndex });
	    }, clearCache: function clearCache() {
	      this.cachedResponse = {}, this.badQueries = [];
	    }, clear: function clear() {
	      this.clearCache(), this.currentValue = "", this.suggestions = [];
	    }, disable: function disable() {
	      var a = this;a.disabled = !0, clearInterval(a.onChangeInterval), a.abortAjax();
	      ...
	      var b = this;if (!b.disabled && !b.visible && a.which === d.DOWN && b.currentValue) return void b.suggest();if (!b.disabled && b.visible) {
	        switch (a.which) {case d.ESC:
	            ...
	            if (b.hint && b.options.onHint) return void b.selectHint();if (-1 === b.selectedIndex) return void b.hide();if (b.select(b.selectedIndex), b.options.tabDisabled === !1) return;break;case d.RETURN:
	            if (-1 === b.selectedIndex) return void b.hide();b.select(b.selectedIndex);break;case d.UP:
	      ...
	      var b = this,
	          c = b.options,
	          d = b.el.val(),
	          e = b.getQuery(d);return b.selection && b.currentValue !== e && (b.selection = null, (c.onInvalidateSelection || a.noop).call(b.element)), clearInterval(b.onChangeInterval), b.currentValue = d, b.selectedIndex = -1, c.triggerSelectOnValidInput && b.isExactMatch(e) ? void b.select(0) : void (e.length < c.minChars ? b.hide() : b.getSuggestions(e));
	      ...
	      var c,
	          ...
	          g = this,
	          h = g.options,
	          i = h.serviceUrl;if (h.params[h.paramName] = b, d = h.ignoreParams ? null : h.params, h.onSearchStart.call(g.element, h.params) !== !1) {
	      ...
	      var b = this,
	          c = a(b.suggestionsContainer);a.isFunction(b.options.onHide) && b.visible && b.options.onHide.call(b.element, c), b.visible = !1, b.selectedIndex = -1, clearInterval(b.onChangeInterval), a(b.suggestionsContainer).hide(), b.signalHint(null);
	      ...
	      if (!this.suggestions.length) return void (this.options.showNoSuggestionNotice ? this.noSuggestions() : this.hide());var b,
	          ...
	          m = "",
	          n = function n(a, c) {
	        var d = a.data[e];return b === d ? "" : (b = d, '<div class="autocomplete-group"><strong>' + b + "</strong></div>");
	      ...
	      var b = this,
	          c = a(b.suggestionsContainer),
	          d = a(b.noSuggestionsContainer);this.adjustContainerWidth(), d.detach(), c.empty(), c.append(d), b.fixPosition(), c.show(), b.visible = !0;
	    }, adjustContainerWidth: function adjustContainerWidth() {
	      var b,
	          c = this,
	          d = c.options,
	          e = a(c.suggestionsContainer);"auto" === d.width && (b = c.el.outerWidth(), e.css("width", b > 0 ? b : 300));
